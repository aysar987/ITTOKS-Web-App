...
export default function PenilaianKognitifPage() {
  ...
  const [scores, setScores] = useState([
    {
      ...
      deskripsi:
        "Mampu menjelaskan konsep dan prinsip kebugaran jasmani dengan...",
      skor: 98,
    },
    {
      aspek: "Pengetahuan prosedural",
      deskripsi:
        "Mampu menjelaskan langkah-langkah teknik dasar secara runtut.",
      skor: 90,
    },
    {
      aspek: "Penerapan pengetahuan",
      deskripsi:
        "Dapat menerapkan aturan dan strategi permainan dalam konteks...",
      skor: 95,
    },
  ]);
            ...
            >
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: 12, marginBottom: 16 }}>
                  ...
                  <button
                    onClick={() => router.push("/penilaian/afektif")}
                    style={{
                      padding: "10px 16px",
                ...
                >
                  <h3 style={{ margin: "0 0 8px 0" }}>KOGNITIF</h3>
                  <div
                    style={{
                      fontSize: 12,
                  ...
                  >
                    TP: Peserta didik mampu menjelaskan konsep dasar, manfaat,
                    serta aturan permainan dan teknik dasar dalam berbagai...
                  </div>
