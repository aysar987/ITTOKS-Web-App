...
export default function PenilaianPsikomotorPage() {
  const router = useRouter();
  const [date, setDate] = useState("03/12/02");
  const [semester, setSemester] = useState("2");
  const [sum, setSum] = useState("SUM 1");
  const [scores, setScores] = useState([
    { aspek: "Teknik", deskripsi: "Kecepatan gerak sesuai standar", skor: 98 },
    {
      aspek: "Kekuatan",
      deskripsi: "Daya tahan & tenaga yg ditam...",
      skor: 90,
    },
    { aspek: "Koordinasi", deskripsi: "Sinkronisasi gerakan", skor: 95 },
  ]);
          ...
          <section className="main-panel">
            ...
            >
              <div>
                ...
                >
                  <h3 style={{ margin: "0 0 8px 0" }}>PSIKOMOTOR</h3>
                  <div
                    style={{
                      fontSize: 12,
                  ...
                  >
                    TP: Peserta didik dapat menampilkan keterampilan teknik
                    dasar dan kombinasi gerak dalam bola basket
                  </div>
